...
*        Aula: 10                     *
*        Título: Funções Recursivas   *
*        Data: 29/03/2019             *
***************************************/
/*	
	Função recursiva é aquelas que chama a si mesma em sua
	execução. Isso é desejável em alguns casos por deixar
	o código mais compacto, mas ela possue maior custo
	computacional, pois é executada várias vezes.
	
	Exercício: Escreva em programa em C que recebe um
	número inteiro positivo e exiba seu fatorial.
*/
#include <stdio.h>
