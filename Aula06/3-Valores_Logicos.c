...
*        Aula: 06                                    *
*        Título: Valores Lógivos: Verdadeiro e Falso *
*        Data: 01/03/2019                            *
******************************************************/
/*
	Como vimos antes, C possui quatro tipos básicos (int, float,
	...
	"falso" e qualquer número diferente de zero (int ou não) como
